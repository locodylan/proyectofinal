...
public class ProductServiceImpl implements ProductService{
	...
	private void loadProducts() {
		 ...
		 springIntro.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple"
				 	+
		 ...
		 springCoreUltimate.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple" 
				 	+
				    "My Introduction Spring Framework Tutorial is designed to give you an introduction to the" 
				 	+
				    "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to make your application more modular and flexible.");
		 ...
		 thymeleaf.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple"
				 	+
				    "My Introduction Spring Framework Tutorial is designed to give you an introduction to the"
				    +
				    "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to make your application more modular and flexible.");
		 ...
		 springCore.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple" 
				 	+
				    "My Introduction Spring Framework Tutorial is designed to give you an introduction to the" 
				 	+
				    "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to make your application more modular and flexible.");
		 ...
		 springCoreAdv.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple" 
				 	+
				    "My Introduction Spring Framework Tutorial is designed to give you an introduction to the" 
				 	+
				    "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to make your application more modular and flexible.");
		 ...
		 springCoreDevOps.setCourseDescripton("Why would you want to learn about the Spring Framework? Simple" 
				 	+
				    "My Introduction Spring Framework Tutorial is designed to give you an introduction to the" 
				 	+
				    "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to make your application more modular and flexible.");
